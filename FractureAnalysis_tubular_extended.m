...
% %         ctodLS          = ctodLS_tub(index,1);
        ...
        % T-stress
        [ Tstr_a, Tstr_c ] = T_stress( a, c, T, W, sigmaSdm, sigmaSdb, flaw );
        %
        ...
        %     [Lr, Kr_a, Kr_c, Krcr, KI_a, KI_c,rhoa, rhoc] = Fracture_tubular(a, c, fyT, fuT, crackLocation, weld, GeometryTub, LoadsTub, JointType, Kmat_a, Kmati_c, Yma, Yba, Ymc, Ybc, sigmaSdm, sigmaSdb, Mma, Mba, Mmc, Mbc);
