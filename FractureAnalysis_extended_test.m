...
% disp('_______')
        elseif (index==7) || (index == 8)
            ...
            [Kmat, ~] = FractureToughnessOSK(fyT, fuT, E, niu, ctodLT, Bctod, Lcrack, 2, Tstr_a);
            [Yma, Yba] = SICfactorY (index, a, c, T, W, L, tw, Wangle, radius, 0, weld, flaw, pi/2, hole);
            [Ma, Mma, Mba, ~] = SIMfactor(flaw, a, c, W, T, pi/2, hole);
            [Lr, ~, ~, ~, ~, ~] = Fracture_TT(flaw, weld, a+hole/2, c, T, W, fyT, fuT,fyweldT, fuweldT, E, sigmaSdm, sigmaSdb, Yma, Yba, Ma, Mma, Mba, Kmat);
            [~, Kr_a, Krcr, KI_a, rhoa, sigmaResM, sigmaResB, Ksb] = Fracture_TT(flaw, weld, a, c, T, W, fyT, fuT,fyweldT, fuweldT, E, sigmaSdm, sigmaSdb, Yma, Yba, Ma, Mma, Mba, Kmat);
            %     Kr_a, Lr, KI_a, Kmat, rhoa
%             xlRange = [ 'A', num2str(index + shift_row)];
%             xlswrite('NIL.xlsx', [Kr_a, 0, Lr, KI_a, 0, Kmat, 0, rhoa, 0], 'Sheet1', xlRange);
...
% disp('_______')            
        elseif (index == 9) || (index == 10)
            [ Tstr_a, Tstr_c ] = T_stress(a+hole/2, c, T, sigmaSdm, sigmaSdb, flaw, W );
            [Kmat, ~] = FractureToughnessOSK(fyweldT, fuweldT, E, niu, ctodLT, Bctod, Lcrack, 2, Tstr_a);
            [Yma, Yba] = SICfactorY (index, a, c, T, W, L, tw, Wangle, radius, 0, weld, flaw, pi/2, hole);
            [Ma, Mma, Mba, ~] = SIMfactor(flaw, a, c, W, T, pi/2, hole);
            [Lr, ~, ~, ~, ~, ~] = Fracture_TT(flaw, weld, a+hole/2, c, T, W, fyT, fuT,fyweldT, fuweldT, E, sigmaSdm, sigmaSdb, Yma, Yba, Ma, Mma, Mba, Kmat);
            [~, Kr_a, Krcr, KI_a, rhoa, sigmaResM, sigmaResB, Ksb] = Fracture_TT(flaw, weld, a, c, T, W, fyT, fuT,fyweldT, fuweldT, E, sigmaSdm, sigmaSdb, Yma, Yba, Ma,  Mma, Mba, Kmat);
...
% disp('_______')
            ...
            [Lr, Kr_a, Kr_c, Krcr, KI_a, KI_c, rhoa, rhoc, sigmaResM, sigmaResB, Ksb] = Fracture(index, flaw, weld, a, c, T, W, fyT, fuT,fyweldT, fuweldT, E, sigmaSdm, sigmaSdb, Yma, Ymc, Yba, Ybc, Mma, Mmc, Mba, Mbc, Kmat_a, Kmati_c, SCF);
